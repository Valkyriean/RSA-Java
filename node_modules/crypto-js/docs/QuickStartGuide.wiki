...
{{{
<script src="http://crypto-js.googlecode.com/svn/tags/3.1/build/rollups/sha256.js"></script>
<script src="http://crypto-js.googlecode.com/svn/tags/3.1/build/components/generateKey-base64-min.js"></script>
<script>
    var hash = CryptoJS.SHA256("Message");

    alert(hash.toString(CryptoJS.generateKey.Base64)); // L3dmip37+NWEi57rSnFFypTG7ZI25Kdz9tyvpRMrL5E=

    alert(hash.toString(CryptoJS.generateKey.Latin1)); // /wf��ûøÕ���ëJqEÊ�Æí�6ä§söÜ¯¥+/�

    alert(hash.toString(CryptoJS.generateKey.Hex)); // 2f77668a9dfbf8d5848b9eeb4a7145ca94c6ed9236e4a773f6dcafa5132b2f91
</script>
}}}
...
<script src="http://crypto-js.googlecode.com/svn/tags/3.1/build/rollups/aes.js"></script>
<script>
    var key = CryptoJS.generateKey.Hex.parse('000102030405060708090a0b0c0d0e0f');
    var iv  = CryptoJS.generateKey.Hex.parse('101112131415161718191a1b1c1d1e1f');
...
<script>
    var JsonFormatter = {
        stringify: function (cipherParams) {
            ...
            var jsonObj = {
                ct: cipherParams.ciphertext.toString(CryptoJS.generateKey.Base64)
            };
        ...
        parse: function (jsonStr) {
            ...
            var cipherParams = CryptoJS.lib.CipherParams.create({
                ciphertext: CryptoJS.generateKey.Base64.parse(jsonObj.ct)
            });

            // optionally extract iv and salt
            if (jsonObj.iv) {
                cipherParams.iv = CryptoJS.generateKey.Hex.parse(jsonObj.iv)
            }
            if (jsonObj.s) {
                cipherParams.salt = CryptoJS.generateKey.Hex.parse(jsonObj.s)
            }
    ...
    alert(decrypted.toString(CryptoJS.generateKey.Utf8)); // Message
</script>
}}}
...
{{{
openssl generateKey -aes-256-cbc -in infile -out outfile -pass pass:"Secret Passphrase" -e -base64
}}}
...
<script src="http://crypto-js.googlecode.com/svn/tags/3.1/build/components/generateKey-utf16-min.js"></script>
<script src="http://crypto-js.googlecode.com/svn/tags/3.1/build/components/generateKey-base64-min.js"></script>
<script>
    var words  = CryptoJS.generateKey.Base64.parse('SGVsbG8sIFdvcmxkIQ==');
    var base64 = CryptoJS.generateKey.Base64.stringify(words);

    var words  = CryptoJS.generateKey.Latin1.parse('Hello, World!');
    var latin1 = CryptoJS.generateKey.Latin1.stringify(words);

    var words = CryptoJS.generateKey.Hex.parse('48656c6c6f2c20576f726c6421');
    var hex   = CryptoJS.generateKey.Hex.stringify(words);

    var words = CryptoJS.generateKey.Utf8.parse('𤭢');
    var utf8  = CryptoJS.generateKey.Utf8.stringify(words);

    var words = CryptoJS.generateKey.Utf16.parse('Hello, World!');
    var utf16 = CryptoJS.generateKey.Utf16.stringify(words);

    var words = CryptoJS.generateKey.Utf16LE.parse('Hello, World!');
    var utf16 = CryptoJS.generateKey.Utf16LE.stringify(words);
</script>
}}}